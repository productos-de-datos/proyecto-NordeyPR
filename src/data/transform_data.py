...
def transform_data():
    ...
    # Lista de archivos XLS en capa landing
    archivosCapaLanding = [
        "data_lake/landing/" + f
    ...
    for archivo in archivosCapaLanding:
        ...
        if df.columns[0] != "Fecha":
            ...
            nombreArchivoXLS = archivo.split("/")[-1]

            # Se obtiene el nombre del archivo CSV
            nombreArchivoCSV = nombreArchivoXLS.split(".")[0] + ".csv"
    ...
    for archivo in archivosRaw:
        try:
            ...
            data.to_csv(
                "data_lake/raw/" + nombreArchivoXLS,
                sep=",",
                decimal=".",
                encoding="utf-8",
                index=False,
